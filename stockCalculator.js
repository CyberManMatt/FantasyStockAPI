const stockCalculator = (
    ...
    const bonuses = gamesPlayedBonus + gamesStartedBonus + pointsPerGameBonus + threesBonus + doubleDoubleBonus + tripleDoubleBonus + assistsBonus + stealsBonus + reboundsBonus + blocksBonus
